...
public class OdooActivity extends AppCompatActivity {
    ...
    private TextView url_none_user;
    private App app;
            ...
            if (!OdooAccountManager.isValidUserObj(this, user)
                ...
                OdooUserObjectUpdater.showUpdater(this, new OdooUserObjectUpdater.OnUpdateFinish() {
                    ...
                    public void userObjectUpdateFinished() {
                        startActivity(new Intent(OdooActivity.this, OdooLoginModify.class));
                        finish();
                    }
...
//            url_none_user.setVisibility(View.VISIBLE);
            return;
        } else {
...
//        url_none_user= (TextView) chosenAccountView.findViewById(R.id.profile_url_text_none_user);

        name.setText(currentUser.getName());
        url.setText((currentUser.isOAuthLogin()) ? currentUser.getInstanceURL() : currentUser.getHost());
//        url_none_user.setText((currentUser.isOAuthLogin()) ? currentUser.getInstanceURL() : currentUser.getHost());
...
//                OControls.setText(view, R.id.profile_url_text_none_user, (user.isOAuthLogin()) ? user.getInstanceURL() : user.getHost());
    ...
    private void accountListDefaultItems() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent loginActivity = new Intent(OdooActivity.this, OdooLoginModify.class);
...
//        OControls.setGone(view, R.id.profile_url_text_none_user);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_ACCOUNTS_MANAGE) {
                startActivity(new Intent(this, OdooLoginModify.class));
                finish();
            }
        }
    }
